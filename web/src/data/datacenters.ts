...
export const datacenterProjects: DatacenterProject[] = [
  ...
  {
    id: '10',
    name: 'Texas Solar & Battery Complex',
    location: 'West Texas',
    totalGPUs: 0,
    gpuAllocations: [],
    fundingGoal: 95000000,
    fundingCurrent: 76000000,
    fundingPercentage: 80,
    expectedAPY: 16.8,
    minInvestment: 5000,
    projectType: 'Energy Grid',
    status: 'Active',
    buildStatus: 'Raising',
    buildProgress: 80,
    powerCapacity: '850 MW Solar + 400 MWh Storage',
    startDate: '2026-02',
    description: 'Massive solar farm with lithium-ion battery storage powering AI datacenters. Located in high-irradiance zone with direct grid connection.',
    coordinates: '31.9686° N, 102.0779° W',
    operatorName: 'SunGrid Energy',
    networkCapacity: 'N/A',
    coolingType: 'N/A',
    uptime: '98.5%',
    constructionUpdates: [
      { date: '2025-10-04', update: 'Solar panel installation 65% complete. 520 MW online.' },
      { date: '2025-09-22', update: 'Battery storage facility construction completed. Testing phase initiated.' },
      { date: '2025-09-10', update: 'Grid interconnection approved by ERCOT. Commercial operation date confirmed.' }
    ]
  },
  {
    id: '11',
    name: 'North Sea Wind Farm',
    location: 'Scottish Coast, UK',
    totalGPUs: 0,
    gpuAllocations: [],
    fundingGoal: 180000000,
    fundingCurrent: 180000000,
    fundingPercentage: 100,
    expectedAPY: 12.5,
    minInvestment: 10000,
    projectType: 'Energy Grid',
    status: 'Funded',
    buildStatus: 'Built',
    powerCapacity: '1.2 GW Offshore Wind',
    startDate: '2025-08',
    description: 'Offshore wind farm with 150 turbines providing clean energy for UK datacenters. Long-term power purchase agreements secured.',
    coordinates: '57.7500° N, 1.0000° W',
    operatorName: 'Atlantic Wind Energy Ltd',
    networkCapacity: 'N/A',
    coolingType: 'N/A',
    uptime: '94.2%'
  },
  {
    id: '12',
    name: 'California Grid Battery Array',
    location: 'Riverside County, CA',
    totalGPUs: 0,
    gpuAllocations: [],
    fundingGoal: 68000000,
    fundingCurrent: 47600000,
    fundingPercentage: 70,
    expectedAPY: 18.2,
    minInvestment: 2500,
    projectType: 'Energy Grid',
    ...
    buildStatus: 'Raising',
    buildProgress: 70,
    powerCapacity: '500 MWh Storage',
    startDate: '2025-12',
    description: 'Large-scale battery storage providing grid stabilization and peak shaving for AI compute facilities. Arbitrage revenue from energy markets.',
    coordinates: '33.7866° N, 116.1689° W',
    operatorName: 'Grid Storage Solutions',
    networkCapacity: 'N/A',
    coolingType: 'N/A',
    uptime: '99.2%',
    constructionUpdates: [
      { date: '2025-10-01', update: 'Battery containers 60% installed. First 300 MWh commissioned.' },
      { date: '2025-09-15', update: 'CAISO interconnection testing successful. Market participation approved.' }
    ]
  },
  {
    id: '13',
    name: 'Morocco Sahara Solar Complex',
    location: 'Ouarzazate, Morocco',
    totalGPUs: 0,
    gpuAllocations: [],
    fundingGoal: 125000000,
    fundingCurrent: 0,
    fundingPercentage: 0,
    expectedAPY: 19.5,
    minInvestment: 5000,
    ...
    buildStatus: 'Raising',
    buildProgress: 0,
    powerCapacity: '1.5 GW Concentrated Solar',
    startDate: '2026-09',
    description: 'Concentrated solar power plant with thermal storage. Export power to European AI infrastructure via HVDC undersea cables.',
    coordinates: '30.9335° N, 6.9370° W',
    operatorName: 'Desert Power International',
    networkCapacity: 'N/A',
    coolingType: 'N/A',
    uptime: '96.8%',
    constructionUpdates: [
      { date: '2025-09-25', update: 'Environmental impact study approved. Land acquisition underway.' }
    ]
  },
  {
    id: '14',
    name: 'Nordic Hydroelectric Upgrade',
    location: 'Norway',
    totalGPUs: 0,
    gpuAllocations: [],
    fundingGoal: 88000000,
    fundingCurrent: 70400000,
    fundingPercentage: 80,
    expectedAPY: 11.2,
    minInvestment: 7500,
    projectType: 'Energy Grid',
    ...
    buildStatus: 'Raising',
    buildProgress: 80,
    powerCapacity: '950 MW Hydro',
    startDate: '2025-11',
    description: 'Modernization of existing hydroelectric dams with smart controls and increased capacity. Reliable baseload power for Nordic datacenters.',
    coordinates: '60.4720° N, 8.4689° E',
    operatorName: 'Nordic Hydro Solutions',
    networkCapacity: 'N/A',
    coolingType: 'N/A',
    uptime: '99.1%',
    constructionUpdates: [
      { date: '2025-10-02', update: 'Turbine upgrades at 3 facilities completed. Efficiency gains exceed projections.' },
      { date: '2025-09-20', update: 'New control systems installed. AI-based load prediction active.' }
    ]
  },
  {
    id: '15',
    name: 'Tokyo Edge Intelligence',
    location: 'Tokyo, Japan',
    totalGPUs: 2304,
    gpuAllocations: [
      { type: 'NVIDIA H100', count: 1536, specs: '80GB HBM3' },
      { type: 'NVIDIA L40S', count: 512, specs: '48GB GDDR6' },
      { type: 'NVIDIA A100', count: 256, specs: '80GB HBM2e' }
    ],
    fundingGoal: 52000000,
    fundingCurrent: 36400000,
    fundingPercentage: 70,
    expectedAPY: 17.5,
    minInvestment: 3000,
    projectType: 'Datacenter',
    ...
    powerCapacity: '28 MW',
    startDate: '2025-12',
    description: 'Ultra-low latency datacenter serving Japanese and Asian markets. Tier IV certified with seismic protection and redundant power systems.',
    coordinates: '35.6762° N, 139.6503° E',
    operatorName: 'Tokyo AI Infrastructure Corp',
    networkCapacity: '800 Gbps',
    coolingType: 'Advanced Liquid Cooling',
    uptime: '99.99%',
    constructionUpdates: [
      { date: '2025-10-05', update: 'Seismic isolation system installation completed. Passed rigorous safety tests.' },
      { date: '2025-09-28', update: 'First H100 GPU rack deployed and operational. Performance benchmarks excellent.' },
      { date: '2025-09-14', update: 'Fiber optic connections to major Tokyo exchanges complete. Sub-millisecond latency confirmed.' }
    ]
  }
];
